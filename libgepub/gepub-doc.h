...
void              gepub_doc_set_chapter                     (GepubDoc *doc,    gint      index);


gchar   	* gepub_doc_get_path  				(GepubDoc *doc);
GList   	*gepub_doc_get_chapter_all    			(GepubDoc *doc);

GepubNavPoint    *gepub_nav_get_list 				(GepubDoc *doc);
gchar 		 *gepub_doc_get_file_fullpath			(GepubDoc *doc,const gchar *tmpuri);
gint              gepub_doc_get_chapter_by_path                 (GepubDoc *doc, const gchar *path);
