...
char * hellostr="hello! my name is linjincheng !sdddddllllllllllllllllllllll你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好ＯＫ";
book_buffer_add32(buf,strlen(hellostr));
book_buffer_addstring(buf,hellostr);
printf("buf=%s\n",buf->data+5);
send(client_socket,buf->data,buf->offset,0);
buf->offset=0;
